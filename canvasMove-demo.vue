<template>
    <div class="box">
        <canvas id="bargraphCanvass" ref="bargraphCanvas" :width="canvasWidth" :height="canvasHeight"></canvas>
    </div>
</template>
...
<script>
	export default {
		data() {
			return {
				canvasWidth: document.body.clientWidth * 0.5, // 画布大小
				canvasHeight: document.body.clientHeight * 0.5,
				myCanvas: null,
				ctx: null,
				...
				extraImg: {url: "https://static.zhihu.com/liukanshan/images/comics/bg-89c9bdc3.jpg"},
				loadImgObj: null,
				img: null,
				flag: false,
				pos: {},
        ...
        mounted() {
			this.canvasHeight = document.body.clientHeight * 0.5;
